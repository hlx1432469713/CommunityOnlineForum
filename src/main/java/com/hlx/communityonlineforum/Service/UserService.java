...
@Service
public class UserService implements CommunityOnlineForumConstant {
    @Autowired
    ...
    public Map<String,Object> register(User user){
        ...
        String url = domain + contextPath + "/activationUser/" + user.getId() + "/" + user.getActivationCode();
        context.setVariable("url",url);
        String content = templateEngine.process("/mail/activation",context);
        mailClient.sendMail(user.getEmail(),"社区在线交流平台账号激活操作",content);
        return map;
    }
